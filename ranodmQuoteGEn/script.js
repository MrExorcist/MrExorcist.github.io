...
var generate= () => {
    var quotes = {
     ...
     "-Albert Eienstein":'“Two things are infinite: the universe and human stupidity; and Im not sure about the universe.”',
     "-Mark Twain":'"If you tell the truth, you dont have to remember anything"',
     "-Friedrich Nietzsche, Twilight of the Idols":'“Without music, life would be a mistake.”',
     "Somebody":'“It is better to be hated for what you are than to be loved for what you are not.”',
     ...
     "- Will Rogers": '"Dont Let Yesterday Take Up Too Much Of Today."',
     "- Unknown": '"You Learn More From Failure Than From Success. Dont Let It Stop You. Failure Builds Character."',
     "- Vince Lombardi": '"Its Not Whether You Get Knocked Down, Its Whether You Get Up."',
     ...
     "- John Lennon": '"Life is what happens to you while youre busy making other plans."',
     "- Earl Nightingale": '"We become what we think about."',
     "- Mark Twain": '"Twenty years from now you will be more disappointed by the things that you didnt do than by the ones you did do, so throw off the bowlines, sail away from safe harbor, catch the trade winds in your sails.  Explore, Dream, Discover."',
     ...
     "- Steve Jobs": '"Your time is limited, so dont waste it living someone elses life."',
     "- Vince Lombardi": '"Winning isnt everything, but wanting to win is."',
     ...
     "- Henry Ford": '"Whether you think you can or you think you cant, youre right."',
     "- Frank Sinatra": '"The best revenge is massive success."',
     "- Zig Ziglar": '"People often say that motivation doesnt last. Well, neither does bathing.  Thats why we recommend it daily."',
